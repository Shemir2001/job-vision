...
export default function CountriesSection() {
  ...
  <div className="group bg-card dark:bg-secondary rounded-xl p-4 text-center hover:shadow-md transition-all hover:-translate-y-1 cursor-pointer border border-transparent hover:border-primary-200 dark:hover:border-primary-700">
    {/* Flag Image */}
    ...
    <p className="text-sm font-medium text-foreground dark:text-white group-hover:text-primary-600 transition-colors">
      {country.name}
    </p>
  </div>
</Link>
        ...
        {/* Remote Work Banner */}
        <motion.div
          className="mt-12 bg-primary-600 dark:bg-primary-900 rounded-2xl p-8 text-center text-white dark:text-foreground"
          initial={{ opacity: 0, y: 20 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          ...
          <Link href="/jobs?remote=true">
            <button className="px-6 py-2 bg-white dark:bg-background text-primary-600 dark:text-primary-400 rounded-lg font-medium hover:bg-primary-50 dark:hover:bg-card transition-colors">
              Browse Remote Jobs
            </button>
          </Link>
        </motion.div>
